...
template <> constexpr inline auto Thread::qt_create_metaobjectdata<qt_meta_tag_ZN6ThreadE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Signal 'error'
        QtMocHelpers::SignalData<void(QAbstractSocket::SocketError)>(1, 2, QMC::AccessPublic, QMetaType::Void, {{
            { 0x80000000 | 3, 4 },
        }}),
        // Slot 'readyRead'
...
void Thread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->error((*reinterpret_cast<std::add_pointer_t<QAbstractSocket::SocketError>>(_a[1]))); break;
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (Thread::*)(QAbstractSocket::SocketError )>(_a, &Thread::error, 0))
            return;
    }
}
...
// SIGNAL 0
void Thread::error(QAbstractSocket::SocketError _t1)
{
