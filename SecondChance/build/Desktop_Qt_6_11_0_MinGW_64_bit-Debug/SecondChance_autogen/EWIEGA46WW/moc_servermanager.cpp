...
template <> constexpr inline auto ServerManager::qt_create_metaobjectdata<qt_meta_tag_ZN13ServerManagerE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        ...
        QtMocHelpers::SignalData<void(bool, QString, int)>(8, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 3 }, { QMetaType::QString, 4 }, { QMetaType::Int, 9 },
        }}),
        // Signal 'alimentarePortofelResult'
        QtMocHelpers::SignalData<void(bool, QString, double)>(10, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 3 }, { QMetaType::QString, 4 }, { QMetaType::Double, 11 },
        }}),
        // Signal 'schimbareMailResult'
        QtMocHelpers::SignalData<void(bool, QString)>(12, 2, QMC::AccessPublic, QMetaType::Void, {{
            { QMetaType::Bool, 3 }, { QMetaType::QString, 4 },
        }}),
...
void ServerManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (ServerManager::*)(bool , QString , int )>(_a, &ServerManager::loginResult, 0))
            return;
        if (QtMocHelpers::indexOfMethod<void (ServerManager::*)(bool , QString )>(_a, &ServerManager::registerResult, 1))
            return;
...
// SIGNAL 1
void ServerManager::registerResult(bool _t1, QString _t2)
{
